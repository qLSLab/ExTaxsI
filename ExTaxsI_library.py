...
def load_configurations(entrez_email,api_key,taxa_database_update='no'):
    ...
    Keyword arguments:
    entrez_email -- email registered on NCBI.
    api_key -- api key generated by NCBI.
    taxa_database_update -- dowload or update taxonomy database (default 'yes').
...
def taxonomyID_converter(text_search = None,file_search = None, input_type = 'O'):
    ...
    file_search -- file search from the user, see examples on documentations (default None).
    input_type -- 'O' organism search, 'T' taxID search (default 'O').
    '''
...
def db_creation(text_search = None,
    ...
    Keyword arguments:
    text_search -- manual input from the user, ex. txid8832 (default None).
    file_search -- file path from the user (default None).
    input_file_type -- 'T','A' or 'O' if the input file is a list of Taxid,
                        accession or organism (default None).
    additional_query -- add string if you want to restrict your output to a specific
